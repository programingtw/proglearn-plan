  ...
  \item 學生課堂頁面：學生的課堂頁面有直播區、互動區、功能區（見圖1）。
    ...
    \begin{figure}[H]
      \begin{subfigure}{0.5\linewidth}
        \centering
        \href{https://raw.githubusercontent.com/programingtw/proglearn-plan/main/img/student2.png}{ 
      ...
      \begin{subfigure}{0.5\linewidth}
        \centering
        \href{https://raw.githubusercontent.com/programingtw/proglearn-plan/main/img/student3.png}{ 
          \includegraphics[width=1\textwidth]{./img/student3.png}
        }
        \caption{課後}
      \end{subfigure}
      \label{arc7}
      \caption{學生課堂頁面 (點擊可看大圖)}
    \end{figure}
    ...
    \item 嵌入式的程式練習題：可以將程式練習題嵌入至講義的內容中，讓學生可以直接作答，並即時得知答案是否正確以及錯誤的原因。此外，教師也能從教學頁中得知學生的作答狀況，以便於調整教學內容。
      \begin{figure}[H]
        ...
        \begin{minipage}{0.35\linewidth}
          \centering
          \href{https://raw.githubusercontent.com/programingtw/proglearn-plan/main/img/problem.png}{
        ...
        \begin{minipage}{0.35\linewidth}
          \centering
          \href{https://raw.githubusercontent.com/programingtw/proglearn-plan/main/img/problem2.png}{
            \includegraphics[width=1\textwidth]{./img/problem2.png}
          }
          \caption{作答後}
          \label{arc9}
        \end{minipage}
        \caption{互動式講義的程式題 (點擊可看大圖)：點擊下方選項後，會自動將選項插入到程式碼中。提交後即時顯示結果。}
      \end{figure}
