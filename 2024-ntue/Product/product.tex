...
該系統在課堂外，提供了課程與作業管理的功能。教師可以在此設定課程章節、作業、測驗、考試與查看學生作答狀況。學生可以在此查看課程資訊（圖\ref{fig:course}）、撰寫作業（圖\ref{fig:homework}）並得到即時批改（圖\ref{fig:course-assignment-flowchart}）。
...
在各個階段中，我們將從小範圍逐漸擴大服務與測試的範圍，以確保系統的穩定性以及減少系統營運的成本。同時，蒐集每一階段市場的反應、使用者的族群、以及他們的反饋，進一步優化我們的服務。
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
      ...
      活動 & 廣徵試用對象 \\ \hline
      參與方式 & 聯繫官方email或line，並填寫使用目的與問卷 \\ \hline
      \multirow{2}{*}{參與條件} & 1. 可以蒐集並授權普羅運用所有課程的紀錄與活動照片 \\ 
      & 2. 需要在課程中放上普羅程式資訊 \\ \hline
      參與對象 & 海洋大學所有師生（不限年級與科系） \\ \hline
      \multirow{3}{*}{承辦方式} & 使用方式：不限（自用、必修、選修、補強、家教、讀書會等） \\ 
      & 時間：視試用的需求而定，分為週、月、學期等 \\ \hline
  \end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
      ...
      \multicolumn{2}{|c|}{\textbf{關鍵活動}} \\ \hline
      活動 & 自辦課程 \\ \hline
      參與方式 & 由團隊與合作單位邀請 \\ \hline
      \multirow{2}{*}{參與條件} & 1. 可以蒐集並授權普羅運用所有課程的紀錄與活動照片 \\ 
      & 2. 需要在課程中放上普羅程式資訊 \\ \hline
      參與對象 & 學生 \\ \hline
      \multirow{4}{*}{承辦方式} & 課程：程式社團/營隊課程 \\ 
      & 夥伴：教學單位（提供教學場所、學生） \\ 
      & 時間：短期（以週為單位） \\ 
      & 場所：二信中學、東山高中、海洋大學或是高中社團等 \\ \hline
  \end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
      \hline
      \multicolumn{2}{|c|}{\textbf{關鍵活動}} \\ \hline
      活動 & 培訓種子教師，將系統應用於自己的課程中 \\ \hline
      參與方式 & 由團隊自行邀請或是自行聯繫官方申請 \\ \hline
      \multirow{2}{*}{參與條件} & 1. 可以蒐集並授權普羅運用所有課程的紀錄與活動照片 \\ 
      & 2. 需要在課程中放上普羅程式資訊 \\ \hline
      參與對象 & 教師 \\ \hline
      \multirow{4}{*}{承辦方式} & 課程：國高中社團及校隊、大學、高中課程等 \\ 
      & 夥伴：教師 \\ 
      & 時間：中期（以學期為單位） \\ 
      & 場所：二信中學、東山高中、海洋大學或是高中社團等 \\ \hline
  \end{tabular}
...
\begin{table}[H]
  \centering
  \caption{尋找教學單位，建立教學軟體專案}
  \begin{tabular}{|l|l|}
      \hline
      \multicolumn{2}{|c|}{\textbf{關鍵活動}} \\ \hline
      活動 & 尋找教學單位，建立教學軟體專案 \\ \hline
      參與方式 & 通過直接聯繫學校、教育機構或教育相關的企業，提出合作提案並商討合作細節 \\ \hline
      \multirow{3}{*}{參與條件} & 1. 具備完整且可靠的教學軟體產品 \\
      & 2. 提供相關技術支持和培訓服務，確保教學單位能夠順利使用和操作軟體 \\
      & 3. 與教學單位協商並簽署合同，明確界定雙方的權利和義務 \\ \hline
      參與對象 & 學校、補習班、教育培訓機構等教學單位 \\ \hline
      \multirow{4}{*}{承辦方式} & 課程：整合公司的教學軟體到教學課程中，例如國高中社團、校隊課程等 \\
      & 夥伴：教學單位將成為公司的合作夥伴，共同推動教學軟體專案 \\
      & 時間：長期合作，以年為單位，持續提供技術支持和服務 \\
      & 場所：學校校園內或是教學機構的教室和設施 \\ \hline
  \end{tabular}
\end{table}
